...
<div className="relative flex items-center justify-center lg:justify-end min-h-[200px] md:min-h-[250px] lg:h-full mt-[-20px] md:mt-0"> 
  ...
  src={ProductCard}
  alt="Product"
  className="relative lg:absolute top-[-60px] md:top-[-40px] lg:top-[-32px] lg:right-0 w-[280px] md:w-[350px] lg:w-[320px] h-auto shadow-2xl rounded-2xl  "
/>
  ...
  {/* ... rest of your code */}
          ...
          <div className="hidden lg:block">
            <img
              src={SmallCard1}
              alt="Loyalty"
              className="absolute bottom-[-35px] right-[190px] w-[180px] h-auto z-20 shadow-xl"
            />
            <img
              src={SmallCard2}
              alt="Markets"
              className="absolute bottom-[-35px] right-[-10px] w-[180px] h-auto z-20 shadow-xl"
            />
            {/* Arrow & Label */}
